...
// pub struct FocaRuntime<'a> {
//     foca: Foca<ID, PostcardCodec, StdRng, Handler<'a>>,
...
//     pub async fn new<'a>(runtime_config: FocaRuntimeConfig) -> Result<FocaRuntime<'a>, anyhow::Error> {
...
//     pub fn broadcast(&self, broadcast_msg: Broadcast) {
